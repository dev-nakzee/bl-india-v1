        ...
        {!isMobile ? (
          <>
            <Box sx={{ display: "flex", alignItems: "center", flexGrow: 1 }}>
              <Link to="/">
                <img src="https://bl-india.com/storage/site_settings/logo.webp" alt="Brand Liaison" style={{ height: "60px" }} />
              </Link>
            </Box>
          ...
          <>
            <Grid container spacing={{xs:0,md:4}} margin={{xs:0,md:1}}>
              <Stack direction={'row'} sx={{ display: "flex", justifyContent:'space-between', alignItems: "center", width:'100%' }}>
                <Box sx={{ display: "flex", alignItems: "center", flexGrow: 1 }}>
                  <Link to="/">
                    <img src="https://bl-india.com/storage/site_settings/logo.webp" alt="Brand Liaison" style={{ height: "35px" }} />
                  </Link>
                </Box>
