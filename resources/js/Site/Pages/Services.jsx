...
const Services = () => {
    ...
    const handleMobileSelectChange = (event) => {
        ...
        const category = serviceData.serviceCategories.find(
    ...
    const filteredServices =
        selectedCategory === "all"
            ...
            : serviceData.services.filter(
                  (service) => service.service_category_id === selectedCategory
              );
    ...
    return (
        <>
            <Helmet>
                ...
                <meta property="og:description" content={serviceData.page.seo_description} />
                <meta property="og:url" content="https://bl-india.com" />
                <meta property="og:site_name" content="Brand Liaison India®" />
                <meta property="og:image" content={'https://bl-india.com'+serviceData.page.image_url} />
                    ...
                    <Sidebar className="Service-section-siderbar">
                        ...
                        >
                            ...
                            <List>
                                ...
                                {serviceData.serviceCategories.map(
                                    (category) => (
                                        <ListItem
                                            key={category.id}
                                            button
